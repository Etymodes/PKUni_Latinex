...
$testCode = Invoke-LoggedCommand { node --disable-warning=ExperimentalWarning --test tests/wechat-oauth.test.mjs tests/vocabulary-adaptive.test.mjs tests/vocabulary-migration.test.mjs }
