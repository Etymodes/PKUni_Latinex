...
$testCode = Invoke-LoggedCommand { node --disable-warning=ExperimentalWarning --test tests/wechat-oauth.test.mjs tests/vocabulary-adaptive.test.mjs tests/vocabulary-migration.test.mjs tests/content-review.test.mjs tests/story-prototype.test.mjs }
