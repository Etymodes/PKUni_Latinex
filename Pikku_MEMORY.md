...
- PR #18：`feat: add first Pikku story lesson`，远端 head 为 `6018558`，当前是可自动合并的 Draft；Cloudflare 已确认该提交部署成功，稳定分支 Preview 为 `https://agent-pikku-p3-3-story-prototype-pkuni-latinex.kimdac.workers.dev/`。在 Augusta 批量检查、Firefox 验收完成并取得明确授权前不得合并。
...
- 2026-08-09：文档恢复提交 `3fff1d2` 已发布，Draft PR #18 已创建并由 GitHub 确认可自动合并；其后文档状态更新至远端 head `6018558`。Cloudflare Workers 评论已确认该提交部署成功并给出稳定分支 Preview；下一步在 Augusta 拉取分支、运行统一报告并用 Firefox 完成交互验收。
